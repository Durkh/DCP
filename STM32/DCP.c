...
extern Log(char const * const tag, char const * const msg, ...);
extern gpio_set_direction(unsigned int pin, unsigned int dir);
extern gpio_set_level(unsigned int pin, unsigned int level);
